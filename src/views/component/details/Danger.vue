        ...
        <DetailCompartment name="Danger Zone" color="error-container">
            <DefaultButton color="error">
                ...
                <ConfirmationDialog
                    ...
                    message="Are you sure you want to delete this component? This deletes all associated versions, interfaces, relations. Further, all issues only present on this component are deleted."
